...
<!--div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
        <ul class="nav nav-sidebar">
            <li><img src="../includes/imagenes/logosup.png" width="90%"></li>
            <li class="active"><a href="#">Marcas<span class="sr-only">(current)</span></a></li>
...
<div class="container-fluid">
 ...
 <!--div class="list-group">
    <img src="../includes/imagenes/logosup.png">
  <a class="list-group-item" href="#"><i class="fa fa-suitcase" aria-hidden="true"></i>&nbsp; Marcas</a>
